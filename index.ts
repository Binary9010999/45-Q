...
//  in a Object. The function should always receive a manufacturer and a model 
//  name. It should then accept an arbitrary number of keyword arguments. Call the function with the
...
// function createCar(manufacturer: string, model: string, ...options: [string, string | number | boolean][]): { [key: string]: string | number | boolean } {
    
//     const car: { [key: string]: string | number | boolean } = {
//       manufacturer,
//       model,
//     };
